...
23.11.17-24.01.20`}
      ...
      <PreTag fontSize={'1.5rem'} fontWeight={700} lineHeight={1.8} margin="10rem 0 0 0">
        {`참여작가`}
      </PreTag>
...
임하은x조현민`}
      ...
      <PreTag fontSize={'2.3rem'} fontWeight={700} lineHeight={1.8} margin="6rem 0 0 0">
        {`《공유시선》 전시 서문`}
      </PreTag>

      <PreTag fontSize={'1.5rem'} fontWeight={400} lineHeight={1.8} margin="1rem 0 0 0">
...
문화살롱 5120은 매년 전시공모를 예정하고 있습니다. 지난 공모에 참여해주신 모든 팀에게 감사의 인사를 전하며 안타깝게 선정되지 못하신 팀에게도 응원의 마음을 전합니다. 올해 공모에 참여해주신 심사위원분들의 심사평을 아래 함께 적습니다. `}
      ...
      <PreTag fontSize={'1.5rem'} fontWeight={400} lineHeight={1.8} margin="1rem 0 6rem 0">
