...
23.11.17-24.01.20`}
      ...
      <PreTag fontSize={'1.5rem'} fontWeight={700} lineHeight={1.8} margin="8rem 0 0 0">
        {`참여작가`}
      </PreTag>
...
임하은x조현민`}
      ...
      <PreTag fontSize={'1.5rem'} fontWeight={400} lineHeight={1.6} margin="6rem 0 0 0">
...
《공유시선 共有視線 The Age's Glance》은 2024년에 펼쳐질 선정작가 전시의 프리뷰 역할을 합니다. 우리는 지금 각자의 시선에서 출발하여 서로 만나는 지점에 서 있습니다. 각 작가의 작품활동에 대한 이해와 향후 이어질 개별 작가의 깊은 이야기들을 기대하면서, 공감과 이해의 순간을 발견할 수 있기를 바랍니다.`}
      ...
      <div style={{ textAlign: 'right' }}>
        <PreTag fontSize={'1.5rem'} fontWeight={400} lineHeight={1.6} margin="3.6rem 0 0 0">
          {`홍해준 문화살롱 5120 프로그램 매니저`}
        </PreTag>
      </div>

      <PreTag fontSize={'2.3rem'} fontWeight={700} lineHeight={1.6} margin="6rem 0 6rem 0">
        {`2023 문화살롱 5120 전시 공모`}
      </PreTag>

      <PreTag fontSize={'1.5rem'} fontWeight={400} lineHeight={1.6} margin="1rem 0 0 0">
...
문화살롱 5120은 매년 전시공모를 예정하고 있습니다. 지난 공모에 참여해주신 모든 팀에게 감사의 인사를 전하며 안타깝게 선정되지 못하신 팀에게도 응원의 마음을 전합니다. 올해 공모에 참여해주신 심사위원분들의 심사평을 아래 함께 적습니다.`}
      ...
      <div style={{ textAlign: 'right' }}>
        <PreTag fontSize={'1.5rem'} fontWeight={400} lineHeight={1.6} margin="3.6rem 0 3.6rem 0">
          {`권태현 미술평론가`}
        </PreTag>
      </div>
      ...
      <div style={{ textAlign: 'right' }}>
        <PreTag fontSize={'1.5rem'} fontWeight={400} lineHeight={1.6} margin="3.6rem 0 10rem 0">
          {`김성근 레인보우큐브 대표`}
        </PreTag>
      </div>
    </Container>
