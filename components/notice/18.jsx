...
· 계약기간 : 2024. 1. 1 ~ 2024. 12. 31 (연장 계약 가능, 퇴직금 적립)  * 비고: 위탁기관인 단국대학교 산학협력단과 계약
...
· 기타 : 4대보험 의무가입, 근로 기간에 따른 연차 제공 및 근로기준법 준수`}
        ...
        <PreTag fontSize={'1.5rem'} fontWeight={400} lineHeight={1.8} margin="0 0 0 1rem" textDecoration="underline">
          {`우대사항`}
        </PreTag>
...
· 서류심사발표 : 12월 13일 (수)   * 서류 합격자에 한하여 개별 연락
