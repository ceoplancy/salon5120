...
const About = () => {
  ...
  return (
    <Frame>
      ...
      <InfoWrapper>
        <FontSize fontSize="1.5rem" fontWeight={400} lineHeight={1.5}>
          문화살롱 5120은 지역 내 청년 예술 창작자들을 발굴하고 지원, 육성하기 위해 노원구에서 진행하는 문화예술청년 지원사업의 이름이자 공간의 이름입니다. 옛 철길과 노원의 자연이 어우러진 경춘선 숲길
          중간에 위치한 문화살롱 5120은 시작하는 예술가가 꿈을 키워갈 수 있는 기반을 마련하며, 구민이 문화예술을 향유하는 일상 속의 장소를 지향합니다. 무한한 영감을 주는 샘터, 문화살롱 5120은 모두에게
          열려 있는 공간이 되고자 합니다.
        </FontSize>
